                    ...
                    <div class="content">
                        <div class="fixed-table-wrap">
                            <table class="table table-sm table-bordered table-hover fixed-table"
                                   onclick="$('#tbody').remove();$('#tbody').load('http://dev.nowgo.tw/backend/stores/{{$store_id}}'+' #tbody');">
...
{{--                                    @foreach($abc as $aaa)--}}
                                        <tr>
                                            ...
                                            <td>測測
                                                <br><span class="text-muted small onhover"><a href="">連結</a>。<a href="">連結</a></span>
                                            </td>
                                            <td>
                                                <strong>停止投放</strong>
                                                    <br>
                                                <span class="text-muted small">已經停止</span>
                                            </td>
                                            <td>
                                                <strong>-</strong>
                                                    <br>
                                                <span class="text-muted small">購買</span>
                                            </td>
