    ...
    $.extend(SmartWizard.prototype, {
        ...
        init: function () {
            ...
            if (idx > 0 && this.options.anchorSettings.markDoneStep && this.options.anchorSettings.markAllPreviousStepsAsDone) {
                ...
                var $doneLi = this.steps.eq(idx).parent('li');
                $doneLi.prevAll().addClass("done");
                $doneLi.prevAll().find('i').removeClass("fa-lock").addClass("fa-check");
            }
        ...
        _setToolbar: function () {
            ...
            var btnGroup = $('<div></div>').addClass('btn-group navbar-btn align-self-center sw-btn-group pull-' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group').append(btnPrevious, btnNext);
